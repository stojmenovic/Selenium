...
public class Youtube {
	...
	public static void main(String[] args) {
		...
		WebElement searchButton = driver.findElement(By.cssSelector(
				"div.style-scope.ytd-app:nth-child(12) div.style-scope.ytd-app:nth-child(1) ytd-masthead.masthead-finish div.style-scope.ytd-masthead:nth-child(4) ytd-searchbox.style-scope.ytd-masthead:nth-child(6) form.style-scope.ytd-searchbox button.style-scope.ytd-searchbox:nth-child(2) > yt-icon.style-scope.ytd-searchbox:nth-child(1)"));
		searchButton.click();

		// klik na locirani xpath prve pesme iz pretrage
		WebElement prvaPesma = driver.findElement(By.xpath(
				"/html[1]/body[1]/ytd-app[1]/div[1]/ytd-page-manager[1]/ytd-search[1]/div[1]/ytd-two-column-search-results-renderer[1]/div[1]/ytd-section-list-renderer[1]/div[2]/ytd-item-section-renderer[1]/div[2]/ytd-video-renderer[1]/div[1]/div[1]/div[1]/div[1]/h3[1]/a[1]"));
